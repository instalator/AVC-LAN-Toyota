...
static AvcInMessage MessageTable [] PROGMEM =
{
  ...
  { ACT_EJECT_CD,    11, {0x62, 0x31, 0xF1, 0x00, 0x30, 0x01, 0xFF, 0xFF, 0xFF, 0x00, 0xC0}, "Eject CD" },
  { ACT_NO_CD,       11, {0x62, 0x31, 0xF1, 0x00, 0xF8, 0x01, 0x01, 0x00, 0x00, 0x00, 0x80}, "No CD" },
